            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="prose prose-invert prose-lg max-w-none">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-300">
                            <strong className="text-white">Important Notice:</strong> TripVega is not the organizer or provider of the displayed tours and activities. The contract for the booked service is concluded directly between you and the respective provider (e.g., Viator).
                        </p>
                    </section>

                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-white mb-4">3. Booking Process</h2>
                        <p className="text-gray-300">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-white mb-4">4. Prices</h2>
                        <p className="text-gray-300">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-white mb-4">5. Cancellation and Refund</h2>
                        <p className="text-gray-300">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-white mb-4">7. Copyright</h2>
                        <p className="text-gray-300">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-white mb-4">8. Final Provisions</h2>
                        <p className="text-gray-300">
