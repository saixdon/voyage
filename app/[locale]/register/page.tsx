    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 py-20 bg-background">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-purple-500/15 rounded-full blur-[120px]" />
            </div>
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="bg-surface/80 backdrop-blur-2xl border border-white/10 rounded-3xl p-10 md:p-12 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="pt-2">
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full h-12 bg-gradient-to-r from-primary to-cyan-500 hover:from-primary/90 hover:to-cyan-500/90 text-white font-bold rounded-xl transition-all duration-300 hover:shadow-[0_0_25px_rgba(43,140,238,0.5)] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {loading ? (
                                    <>
                        ...
                        <p className="text-xs text-muted-foreground text-center">
                            ...
                            <Link href={`/${locale}/agb`} className="text-primary hover:underline">
                                AGB
                            </Link>{" "}
                            und{" "}
                    ...
                    <button
                        type="button"
                        disabled
                        className="w-full h-12 bg-white/5 hover:bg-white/10 border border-white/10 text-foreground font-medium rounded-xl transition-all flex items-center justify-center gap-3 opacity-50 cursor-not-allowed"
                    >
