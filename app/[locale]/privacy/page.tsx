            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="prose dark:prose-invert prose-lg max-w-none">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">1. Controller</h2>
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">2. Collection and Processing of Personal Data</h2>
                        ...
                        <h3 className="text-xl font-medium text-foreground mb-2">2.1 When visiting our website</h3>
                        <p className="text-muted-foreground">
                    ...
                    <section className="mb-8">
                        ...
                        <h3 className="text-xl font-medium text-foreground mb-2">4.1 Viator (TripAdvisor)</h3>
                        <p className="text-muted-foreground">
